...
export default function AutoCountAccountingPage({ onContact }) {
  ...
  return (
    <div id="page-autocount-accounting" className="pinned-hero-page product-app-page" style={{ minHeight: "100vh" }} suppressHydrationWarning>
      ...
      <EnquireNowCTA
        ...
        body="KS Support Team provides full AutoCount implementation, training, and support across Malaysia."
